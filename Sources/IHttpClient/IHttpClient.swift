...
public final actor IHttpClient: DefaultHttpClient {
  ...
  // MARK: - Public Methods (Default Error Model)
  ...
  public func request<T: Decodable & Sendable>(
    ...
    try await _request(path: path, method: method, parameters: parameters, headers: headers)
  }
  
  public func performRawRequest<T: Decodable & Sendable>(
    _ path: String,
    method: HTTPMethod = .get,
    parameters: [String: Any]? = nil,
    headers: [String: String]? = nil
  ) async throws -> HTTPResponse<T> {
    try await _performRawRequest(path: path, method: method, parameters: parameters, headers: headers)
  }
  
  // MARK: - Public Methods (Custom Error Model)
  ...
  private func _request<T: Decodable & Sendable, E: Decodable & Sendable>(
    ...
    errorModelType: E.Type = APIErrorResponse.self
  ) async throws -> HTTPResponse<T> {
